...
const Feedback = () => {
  ...
  const questions = [
    "On a scale of 1 to 5, how convinced are you with the presentation and information delivered by the department?",
    "On a scale of 1 to 5, how well does the significance of projects, models and demo works?",
    "On a scale of 1 to 5, how would you rate your overall experience at the department?",
  ];
  ...
  return (
    <div className="flex justify-center bg-[#158EB4] min-h-screen py-6">
      <div className="flex flex-col items-center gap-y-10">
        ...
        <p className="text-center px-2 text-2xl font-extrabold text-white">
          {department.name}
        </p>
