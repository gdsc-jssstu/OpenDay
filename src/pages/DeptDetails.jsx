...
const DeptDetails = () => {
  ...
  return (
    <div>
      ...
      <Link to={data.prevVenue} className="flex-1 py-6 text-center text-lg font-semibold ">
          Previous Venue
        </Link>
        <Link href={data.nextVenue} className="flex-1 py-6 text-center text-lg font-semibold ">
          Next Venue
        </Link>
      </div>
    </div>
